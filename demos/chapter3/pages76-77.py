...
# the following line is a ternary operator 
# (an if-else statement written on a single line)
customer_type_full = "Retail" if customer_type.lower() == "r" else \
                      "Wholesale" if customer_type.lower() == "w" else \
                      "Unknown"
